...
const extractMedia                = async (collection)  => collection.then(x => x.graphql.shortcode_media)

const extractDisplayResources     = async (collection)  => collection.then(x => x.edge_sidecar_to_children != undefined
